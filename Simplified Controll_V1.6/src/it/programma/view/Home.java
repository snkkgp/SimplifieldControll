...
public class Home {
	...
	private List<Riscontro> riscontri;
	...
	private void initialize() {
		...
		panel.setBounds(142, 11, 705, 272);
		...
		btnRicerca.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if((textFieldRicercaTarga.getText().equals("")) && (textRIcercaImporto.getText().equals(""))
						...
						&& (textFieldAAAA.getText().equals("")) ) {	
					JOptionPane.showMessageDialog(null,"Compilare campo Targa, o campo Importo, o Data e tipo Riscontro ",
				...
				if(textEmpy != true && errDate != true) {
					try {
						...
						riscontri = GestionaleBussiness.getInstance().ricerca(riscontro);
			...
			public void actionPerformed(ActionEvent arg0) {
				if((!textFieldServerIp.getText().equals("")) && (!textFieldPortaNum.getText().equals("")) &&
					...
					try {
						...
						properties.setProperty("Version", "V1.6 del 06/06/2018");
		...
		panel_3.setBounds(116, 343, 773, 279);
		...
		lblTotale.setBounds(466, 246, 86, 14);
		...
		texttotale.setBounds(586, 244, 86, 20);
		...
		buttonStampa.setBounds(343, 243, 89, 23);
		buttonStampa.setEnabled(false);
		panel_3.add(buttonStampa);
	...
	/////visuliazza tutti i riscontri in database/////////////////
