...
///////////////creoFile se non gia esistente///////////
	...
	public List<Riscontro> ricerca(Riscontro riscontro) throws SQLException {

		String sql = "SELECT *FROM riscontro WHERE (data_inserimento = ? AND tipo = ?) OR targa_Polizza = ? OR importo = ? ORDER BY CURRENT_DATE() DESC";
